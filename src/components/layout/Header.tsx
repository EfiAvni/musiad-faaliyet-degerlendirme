...
export function TopHeader({ onToggleSidebar, currentPageLabel, user, onNavigate }: {
  onToggleSidebar: () => void; currentPageLabel: string; user: User; onNavigate: (p: Page) => void
}) {
  ...
  return (
    <header className="flex items-center justify-between px-6 bg-white border-b border-gray-100" style={{ height: 64 }}>
      ...
      <div className="flex items-center gap-3">
        ...
        <BildirimMenusu onNavigate={onNavigate} />
